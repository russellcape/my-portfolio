      ...
      <div className="flex-about">
        <div className="about-text">
          ...
          <p>
            ...
            and Python and I am versed with a variety of development tools and frameworks, including Django, React, 
            Next.js, Node.js and Ruby on Rails. I am always eager to learn and explore new technologies, and I am 
            constantly seeking out opportunities to improve my skills and knowledge.
          </p>
        </div>
